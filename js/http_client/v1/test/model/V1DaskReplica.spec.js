...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PolyaxonSdk.V1DaskReplica();
  });
  ...
  describe('V1DaskReplica', function() {
    it('should create an instance of V1DaskReplica', function() {
      // uncomment below and update the code to test V1DaskReplica
      //var instance = new PolyaxonSdk.V1DaskReplica();
      //expect(instance).to.be.a(PolyaxonSdk.V1DaskReplica);
    });
