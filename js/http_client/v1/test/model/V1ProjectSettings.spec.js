...
(function(root, factory) {
  ...
  describe('V1ProjectSettings', function() {
    ...
    it('should have the property restrictions_template (base name: "restrictions_template")', function() {
      // uncomment below and update the code to test the property restrictions_template
      //var instance = new PolyaxonSdk.V1ProjectSettings();
      //expect(instance).to.be();
    });
