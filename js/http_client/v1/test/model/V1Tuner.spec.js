...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PolyaxonSdk.V1Tuner();
  });
  ...
  describe('V1Tuner', function() {
    it('should create an instance of V1Tuner', function() {
      // uncomment below and update the code to test V1Tuner
      //var instance = new PolyaxonSdk.V1Tuner();
      //expect(instance).to.be.a(PolyaxonSdk.V1Tuner);
    });
