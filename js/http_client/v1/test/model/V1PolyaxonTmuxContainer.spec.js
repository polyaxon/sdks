...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PolyaxonSdk.V1PolyaxonTmuxContainer();
  });
  ...
  describe('V1PolyaxonTmuxContainer', function() {
    it('should create an instance of V1PolyaxonTmuxContainer', function() {
      // uncomment below and update the code to test V1PolyaxonTmuxContainer
      //var instance = new PolyaxonSdk.V1PolyaxonTmuxContainer();
      //expect(instance).to.be.a(PolyaxonSdk.V1PolyaxonTmuxContainer);
    });
