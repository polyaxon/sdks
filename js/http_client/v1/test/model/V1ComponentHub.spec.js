...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PolyaxonSdk.V1ComponentHub();
  });
  ...
  describe('V1ComponentHub', function() {
    it('should create an instance of V1ComponentHub', function() {
      // uncomment below and update the code to test V1ComponentHub
      //var instance = new PolyaxonSdk.V1ComponentHub();
      //expect(instance).to.be.a(PolyaxonSdk.V1ComponentHub);
    });
