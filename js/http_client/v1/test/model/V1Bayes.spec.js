...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PolyaxonSdk.V1Bayes();
  });
  ...
  describe('V1Bayes', function() {
    it('should create an instance of V1Bayes', function() {
      // uncomment below and update the code to test V1Bayes
      //var instance = new PolyaxonSdk.V1Bayes();
      //expect(instance).to.be.a(PolyaxonSdk.V1Bayes);
    });
    ...
    it('should have the property numInitialRuns (base name: "numInitialRuns")', function() {
      // uncomment below and update the code to test the property numInitialRuns
      //var instance = new PolyaxonSdk.V1Bayes();
      //expect(instance).to.be();
    });
    ...
    it('should have the property utilityFunction (base name: "utilityFunction")', function() {
      // uncomment below and update the code to test the property utilityFunction
      //var instance = new PolyaxonSdk.V1Bayes();
      //expect(instance).to.be();
    });
