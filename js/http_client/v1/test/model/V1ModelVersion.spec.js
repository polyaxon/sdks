...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PolyaxonSdk.V1ModelVersion();
  });
  ...
  describe('V1ModelVersion', function() {
    it('should create an instance of V1ModelVersion', function() {
      // uncomment below and update the code to test V1ModelVersion
      //var instance = new PolyaxonSdk.V1ModelVersion();
      //expect(instance).to.be.a(PolyaxonSdk.V1ModelVersion);
    });
    ...
    it('should have the property run_info (base name: "run_info")', function() {
      // uncomment below and update the code to test the property run_info
      //var instance = new PolyaxonSdk.V1ModelVersion();
      //expect(instance).to.be();
    });
