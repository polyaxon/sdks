...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PolyaxonSdk.V1ModelRegistry();
  });
  ...
  describe('V1ModelRegistry', function() {
    it('should create an instance of V1ModelRegistry', function() {
      // uncomment below and update the code to test V1ModelRegistry
      //var instance = new PolyaxonSdk.V1ModelRegistry();
      //expect(instance).to.be.a(PolyaxonSdk.V1ModelRegistry);
    });
