...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PolyaxonSdk.V1ComponentVersion();
  });
  ...
  describe('V1ComponentVersion', function() {
    it('should create an instance of V1ComponentVersion', function() {
      // uncomment below and update the code to test V1ComponentVersion
      //var instance = new PolyaxonSdk.V1ComponentVersion();
      //expect(instance).to.be.a(PolyaxonSdk.V1ComponentVersion);
    });
