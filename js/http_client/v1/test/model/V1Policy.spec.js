...
(function(root, factory) {
  ...
  describe('V1Policy', function() {
    ...
    it('should have the property projects_settings (base name: "projects_settings")', function() {
      // uncomment below and update the code to test the property projects_settings
      //var instance = new PolyaxonSdk.V1Policy();
      //expect(instance).to.be();
    });
