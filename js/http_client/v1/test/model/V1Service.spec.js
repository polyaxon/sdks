...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PolyaxonSdk.V1Service();
  });
  ...
  describe('V1Service', function() {
    it('should create an instance of V1Service', function() {
      ...
      //var instance = new PolyaxonSdk.V1Service();
      //expect(instance).to.be.a(PolyaxonSdk.V1Service);
    });
    ...
    it('should have the property rewritePath (base name: "rewritePath")', function() {
      // uncomment below and update the code to test the property rewritePath
      //var instance = new PolyaxonSdk.V1Service();
      //expect(instance).to.be();
    });
