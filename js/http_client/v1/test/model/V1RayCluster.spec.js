...
(function(root, factory) {
  ...
  describe('V1RayCluster', function() {
    ...
    it('should have the property enableInTreeAutoscaling (base name: "enableInTreeAutoscaling")', function() {
      // uncomment below and update the code to test the property enableInTreeAutoscaling
      //var instance = new PolyaxonSdk.V1RayCluster();
      //expect(instance).to.be();
    });

    it('should have the property autoscalerOptions (base name: "autoscalerOptions")', function() {
      // uncomment below and update the code to test the property autoscalerOptions
      //var instance = new PolyaxonSdk.V1RayCluster();
      //expect(instance).to.be();
    });
