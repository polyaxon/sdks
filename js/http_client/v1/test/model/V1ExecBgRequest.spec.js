...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PolyaxonSdk.V1ExecBgRequest();
  });
  ...
  describe('V1ExecBgRequest', function() {
    it('should create an instance of V1ExecBgRequest', function() {
      // uncomment below and update the code to test V1ExecBgRequest
      //var instance = new PolyaxonSdk.V1ExecBgRequest();
      //expect(instance).to.be.a(PolyaxonSdk.V1ExecBgRequest);
    });
