...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PolyaxonSdk.V1SparkJob();
  });
  ...
  describe('V1SparkJob', function() {
    it('should create an instance of V1SparkJob', function() {
      // uncomment below and update the code to test V1SparkJob
      //var instance = new PolyaxonSdk.V1SparkJob();
      //expect(instance).to.be.a(PolyaxonSdk.V1SparkJob);
    });
