...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PolyaxonSdk.V1ConnectionType();
  });
  ...
  describe('V1ConnectionType', function() {
    it('should create an instance of V1ConnectionType', function() {
      // uncomment below and update the code to test V1ConnectionType
      //var instance = new PolyaxonSdk.V1ConnectionType();
      //expect(instance).to.be.a(PolyaxonSdk.V1ConnectionType);
    });
