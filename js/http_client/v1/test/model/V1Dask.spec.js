...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PolyaxonSdk.V1Dask();
  });
  ...
  describe('V1Dask', function() {
    it('should create an instance of V1Dask', function() {
      // uncomment below and update the code to test V1Dask
      //var instance = new PolyaxonSdk.V1Dask();
      //expect(instance).to.be.a(PolyaxonSdk.V1Dask);
    });
    ...
    it('should have the property adaptMin (base name: "adaptMin")', function() {
      // uncomment below and update the code to test the property adaptMin
      //var instance = new PolyaxonSdk.V1Dask();
      //expect(instance).to.be();
    });

    it('should have the property adaptMax (base name: "adaptMax")', function() {
      // uncomment below and update the code to test the property adaptMax
      //var instance = new PolyaxonSdk.V1Dask();
      //expect(instance).to.be();
    });

    it('should have the property adaptInterval (base name: "adaptInterval")', function() {
      // uncomment below and update the code to test the property adaptInterval
      //var instance = new PolyaxonSdk.V1Dask();
      //expect(instance).to.be();
    });
