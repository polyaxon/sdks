...
class V1PolyaxonSidecarContainer {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('noConnections')) {
                obj['noConnections'] = ApiClient.convertToType(data['noConnections'], 'Boolean');
            }
...
/**
 * @member {Boolean} noConnections
 */
V1PolyaxonSidecarContainer.prototype['noConnections'] = undefined;
