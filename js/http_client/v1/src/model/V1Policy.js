...
class V1Policy {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('projects_settings')) {
                obj['projects_settings'] = ApiClient.convertToType(data['projects_settings'], ['String']);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        // ensure the json data is an array
        if (!Array.isArray(data['projects_settings'])) {
            throw new Error("Expected the field `projects_settings` to be an array in the JSON data but got " + data['projects_settings']);
        }
...
/**
 * @member {Array.<String>} projects_settings
 */
V1Policy.prototype['projects_settings'] = undefined;
