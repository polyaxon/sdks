...
/**
 * The V1RandomSearch model module.
 * @module model/V1RandomSearch
 * @version 2.12.0-rc8
 */
class V1RandomSearch {
    /**
     * Constructs a new <code>V1RandomSearch</code>.
     * @alias module:model/V1RandomSearch
     */
    constructor() {

        V1RandomSearch.initialize(this);
    }
    ...
    /**
     * Constructs a <code>V1RandomSearch</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/V1RandomSearch} obj Optional instance to populate.
     * @return {module:model/V1RandomSearch} The populated <code>V1RandomSearch</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new V1RandomSearch();
 ...
 * @default 'random'
 */
V1RandomSearch.prototype['kind'] = 'random';

/**
 * @member {Object.<String, Object>} params
 */
V1RandomSearch.prototype['params'] = undefined;

/**
 * @member {Number} numRuns
 */
V1RandomSearch.prototype['numRuns'] = undefined;

/**
 * @member {Number} seed
 */
V1RandomSearch.prototype['seed'] = undefined;

/**
 * @member {Number} concurrency
 */
V1RandomSearch.prototype['concurrency'] = undefined;

/**
 * @member {Array.<Object>} earlyStopping
 */
V1RandomSearch.prototype['earlyStopping'] = undefined;
