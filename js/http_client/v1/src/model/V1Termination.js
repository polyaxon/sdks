...
import V1ActivityProbe from './V1ActivityProbe';
import V1Culling from './V1Culling';
...
class V1Termination {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('culling')) {
                obj['culling'] = V1Culling.constructFromObject(data['culling']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['culling']) { // data not null
          V1Culling.validateJSON(data['culling']);
        }
        // validate the optional field `probe`
        if (data['probe']) { // data not null
          V1ActivityProbe.validateJSON(data['probe']);
        }
...
/**
 * @member {module:model/V1Culling} culling
 */
V1Termination.prototype['culling'] = undefined;
