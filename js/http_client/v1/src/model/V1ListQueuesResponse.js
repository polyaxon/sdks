...
class V1ListQueuesResponse {
    ...
    /**
     * Validates the JSON data with respect to <code>V1ListQueuesResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>V1ListQueuesResponse</code>.
     */
