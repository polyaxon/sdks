...
import V1PaddleElasticPolic from './V1PaddleElasticPolic';
import V1SchedulingPolicy from './V1SchedulingPolicy';

/**
 * The V1PaddleJob model module.
 * @module model/V1PaddleJob
 * @version 2.3.1
 */
class V1PaddleJob {
    /**
    ...
    /**
     * Constructs a <code>V1PaddleJob</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/V1PaddleJob} obj Optional instance to populate.
     * @return {module:model/V1PaddleJob} The populated <code>V1PaddleJob</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new V1PaddleJob();
            ...
            if (data.hasOwnProperty('elasticPolicy')) {
                obj['elasticPolicy'] = V1PaddleElasticPolic.constructFromObject(data['elasticPolicy']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>V1PaddleJob</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>V1PaddleJob</code>.
     */
    static validateJSON(data) {
        ...
        if (data['elasticPolicy']) { // data not null
          V1PaddleElasticPolic.validateJSON(data['elasticPolicy']);
        }
 ...
 */
V1PaddleJob.prototype['cleanPodPolicy'] = undefined;

/**
 * @member {module:model/V1SchedulingPolicy} schedulingPolicy
 */
V1PaddleJob.prototype['schedulingPolicy'] = undefined;

/**
 * @member {module:model/V1PaddleElasticPolic} elasticPolicy
 */
V1PaddleJob.prototype['elasticPolicy'] = undefined;

/**
 * @member {module:model/V1KFReplica} master
 */
V1PaddleJob.prototype['master'] = undefined;

/**
 * @member {module:model/V1KFReplica} worker
 */
V1PaddleJob.prototype['worker'] = undefined;
