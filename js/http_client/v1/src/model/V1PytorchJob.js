...
import V1PytorchElasticPolicy from './V1PytorchElasticPolicy';
...
class V1PytorchJob {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('elasticPolicy')) {
                obj['elasticPolicy'] = V1PytorchElasticPolicy.constructFromObject(data['elasticPolicy']);
            }
            ...
            if (data.hasOwnProperty('nProcPerNode')) {
                obj['nProcPerNode'] = ApiClient.convertToType(data['nProcPerNode'], 'String');
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['elasticPolicy']) { // data not null
          V1PytorchElasticPolicy.validateJSON(data['elasticPolicy']);
        }
        ...
        // ensure the json data is a string
        if (data['nProcPerNode'] && !(typeof data['nProcPerNode'] === 'string' || data['nProcPerNode'] instanceof String)) {
            throw new Error("Expected the field `nProcPerNode` to be a primitive type in the JSON string but got " + data['nProcPerNode']);
        }
...
/**
 * @member {module:model/V1PytorchElasticPolicy} elasticPolicy
 */
V1PytorchJob.prototype['elasticPolicy'] = undefined;
...
/**
 * @member {String} nProcPerNode
 */
V1PytorchJob.prototype['nProcPerNode'] = undefined;
