...
import V1UserAccessData from './V1UserAccessData';
...
class V1UserAccess {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('user_data')) {
                obj['user_data'] = V1UserAccessData.constructFromObject(data['user_data']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['user_data']) { // data not null
          V1UserAccessData.validateJSON(data['user_data']);
        }
        // ensure the json data is a string
...
/**
 * @member {module:model/V1UserAccessData} user_data
 */
V1UserAccess.prototype['user_data'] = undefined;
 ...
 */
V1UserAccess.prototype['default_presets'] = undefined;

/**
 * @member {Array.<String>} default_presets_ordered
 */
V1UserAccess.prototype['default_presets_ordered'] = undefined;
