...
class V1ProjectSettings {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('restrictions_template')) {
                obj['restrictions_template'] = ApiClient.convertToType(data['restrictions_template'], 'String');
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['restrictions_template'] && !(typeof data['restrictions_template'] === 'string' || data['restrictions_template'] instanceof String)) {
            throw new Error("Expected the field `restrictions_template` to be a primitive type in the JSON string but got " + data['restrictions_template']);
        }
...
/**
 * @member {String} restrictions_template
 */
V1ProjectSettings.prototype['restrictions_template'] = undefined;
