...
import SparkJobDeployMode from './SparkJobDeployMode';
import V1SparkJobType from './V1SparkJobType';
import V1SparkReplica from './V1SparkReplica';

/**
 * The V1SparkJob model module.
 * @module model/V1SparkJob
 * @version 2.0.0-rc26
 */
class V1SparkJob {
    /**
     * Constructs a new <code>V1SparkJob</code>.
     * @alias module:model/V1SparkJob
     */
    constructor() {

        V1SparkJob.initialize(this);
    }
    ...
    /**
     * Constructs a <code>V1SparkJob</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/V1SparkJob} obj Optional instance to populate.
     * @return {module:model/V1SparkJob} The populated <code>V1SparkJob</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new V1SparkJob();
            ...
            if (data.hasOwnProperty('type')) {
                obj['type'] = V1SparkJobType.constructFromObject(data['type']);
            }
            ...
            if (data.hasOwnProperty('deployMode')) {
                obj['deployMode'] = SparkJobDeployMode.constructFromObject(data['deployMode']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>V1SparkJob</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>V1SparkJob</code>.
     */
 ...
 * @default 'spark_job'
 */
V1SparkJob.prototype['kind'] = 'spark_job';

/**
 * @member {Array.<String>} connections
 */
V1SparkJob.prototype['connections'] = undefined;

/**
 * Volumes is a list of volumes that can be mounted.
 * @member {Array.<Object>} volumes
 */
V1SparkJob.prototype['volumes'] = undefined;

/**
 * @member {module:model/V1SparkJobType} type
 */
V1SparkJob.prototype['type'] = undefined;

/**
 * Spark version is the version of Spark the application uses.
 * @member {String} sparkVersion
 */
V1SparkJob.prototype['sparkVersion'] = undefined;

/**
 * Spark version is the version of Spark the application uses.
 * @member {String} pythonVersion
 */
V1SparkJob.prototype['pythonVersion'] = undefined;

/**
 * @member {module:model/SparkJobDeployMode} deployMode
 */
V1SparkJob.prototype['deployMode'] = undefined;
 ...
 */
V1SparkJob.prototype['mainClass'] = undefined;

/**
 * MainFile is the path to a bundled JAR, Python, or R file of the application.
 * @member {String} mainApplicationFile
 */
V1SparkJob.prototype['mainApplicationFile'] = undefined;

/**
 * Arguments is a list of arguments to be passed to the application.
 * @member {Array.<String>} arguments
 */
V1SparkJob.prototype['arguments'] = undefined;
 ...
 */
V1SparkJob.prototype['hadoopConf'] = undefined;

/**
 * HadoopConf carries user-specified Hadoop configuration properties as they would use the  the \"--conf\" option in spark-submit.  The SparkApplication controller automatically adds prefix \"spark.hadoop.\" to Hadoop configuration properties.
 * @member {Object.<String, String>} sparkConf
 */
V1SparkJob.prototype['sparkConf'] = undefined;
 ...
 */
V1SparkJob.prototype['sparkConfigMap'] = undefined;
 ...
 */
V1SparkJob.prototype['hadoopConfigMap'] = undefined;

/**
 * @member {module:model/V1SparkReplica} executor
 */
V1SparkJob.prototype['executor'] = undefined;

/**
 * @member {module:model/V1SparkReplica} driver
 */
V1SparkJob.prototype['driver'] = undefined;
