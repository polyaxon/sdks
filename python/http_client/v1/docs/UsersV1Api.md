...
[**get_history**](UsersV1Api.md#get_history) | **GET** /api/v1/users/history | User History
[**get_suggestions**](UsersV1Api.md#get_suggestions) | **GET** /api/v1/users/suggestions | User suggestions
...
[**get_workspaces**](UsersV1Api.md#get_workspaces) | **GET** /api/v1/users/workspaces | User workspaces
...
# **get_history**
> V1ListActivitiesResponse get_history(offset=offset, limit=limit, sort=sort, query=query, no_page=no_page)
...
# **get_suggestions**
> object get_suggestions(offset=offset, limit=limit, sort=sort, query=query, no_page=no_page)
...
# **get_workspaces**
> object get_workspaces(offset=offset, limit=limit, sort=sort, query=query, no_page=no_page)
...
with polyaxon_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        # User workspaces
        api_response = api_instance.get_workspaces(offset=offset, limit=limit, sort=sort, query=query, no_page=no_page)
        print("The response of UsersV1Api->get_workspaces:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling UsersV1Api->get_workspaces: %s\n" % e)
```
