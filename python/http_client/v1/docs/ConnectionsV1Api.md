...
> V1ListConnectionsResponse list_connection_names(owner, offset=offset, limit=limit, sort=sort, query=query, bookmarks=bookmarks, mode=mode, no_page=no_page)
...
# **list_connections**
> V1ListConnectionsResponse list_connections(owner, offset=offset, limit=limit, sort=sort, query=query, bookmarks=bookmarks, mode=mode, no_page=no_page)
