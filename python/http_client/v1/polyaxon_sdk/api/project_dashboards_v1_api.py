...
class ProjectDashboardsV1Api(object):
    ...
    def list_project_dashboard_names(self, owner : Annotated[StrictStr, Field(..., description="Owner of the namespace")], name : Annotated[StrictStr, Field(..., description="Entity managing the resource")], run : Annotated[Optional[StrictStr], Field(description="Run.")] = None, offset : Annotated[Optional[StrictInt], Field(description="Pagination offset.")] = None, limit : Annotated[Optional[StrictInt], Field(description="Limit size.")] = None, sort : Annotated[Optional[StrictStr], Field(description="Sort to order the search.")] = None, query : Annotated[Optional[StrictStr], Field(description="Query filter the search.")] = None, bookmarks : Annotated[Optional[StrictBool], Field(description="Filter by bookmarks.")] = None, mode : Annotated[Optional[StrictStr], Field(description="Mode of the search.")] = None, no_page : Annotated[Optional[StrictBool], Field(description="No pagination.")] = None, **kwargs) -> V1ListDashboardsResponse:  # noqa: E501
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.list_project_dashboard_names_with_http_info(owner, name, run, offset, limit, sort, query, bookmarks, mode, no_page, **kwargs)  # noqa: E501
    ...
    def list_project_dashboards(self, owner : Annotated[StrictStr, Field(..., description="Owner of the namespace")], name : Annotated[StrictStr, Field(..., description="Entity managing the resource")], run : Annotated[Optional[StrictStr], Field(description="Run.")] = None, offset : Annotated[Optional[StrictInt], Field(description="Pagination offset.")] = None, limit : Annotated[Optional[StrictInt], Field(description="Limit size.")] = None, sort : Annotated[Optional[StrictStr], Field(description="Sort to order the search.")] = None, query : Annotated[Optional[StrictStr], Field(description="Query filter the search.")] = None, bookmarks : Annotated[Optional[StrictBool], Field(description="Filter by bookmarks.")] = None, mode : Annotated[Optional[StrictStr], Field(description="Mode of the search.")] = None, no_page : Annotated[Optional[StrictBool], Field(description="No pagination.")] = None, **kwargs) -> V1ListDashboardsResponse:  # noqa: E501
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.list_project_dashboards_with_http_info(owner, name, run, offset, limit, sort, query, bookmarks, mode, no_page, **kwargs)  # noqa: E501
    ...
    @validate_arguments
    def promote_project_dashboard(self, owner : Annotated[StrictStr, Field(..., description="Owner of the namespace")], entity : Annotated[StrictStr, Field(..., description="Entity: project name, hub name, registry name, ...")], uuid : Annotated[StrictStr, Field(..., description="Uuid identifier of the sub-entity")], body : V1OwnerSubEntityResourcePromoteRequest, **kwargs) -> None:  # noqa: E501
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.promote_project_dashboard_with_http_info(owner, entity, uuid, body, **kwargs)  # noqa: E501

    @validate_arguments
    def promote_project_dashboard_with_http_info(self, owner : Annotated[StrictStr, Field(..., description="Owner of the namespace")], entity : Annotated[StrictStr, Field(..., description="Entity: project name, hub name, registry name, ...")], uuid : Annotated[StrictStr, Field(..., description="Uuid identifier of the sub-entity")], body : V1OwnerSubEntityResourcePromoteRequest, **kwargs):  # noqa: E501
        """Promote project dashboard  # noqa: E501
