...
class ProjectSearchesV1Api(object):
    ...
    def promote_project_search(self, owner : Annotated[StrictStr, Field(..., description="Owner of the namespace")], entity : Annotated[StrictStr, Field(..., description="Entity: project name, hub name, registry name, ...")], uuid : Annotated[StrictStr, Field(..., description="Uuid identifier of the sub-entity")], body : V1OwnerSubEntityResourcePromoteRequest, **kwargs) -> None:  # noqa: E501
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.promote_project_search_with_http_info(owner, entity, uuid, body, **kwargs)  # noqa: E501

    @validate_arguments
    def promote_project_search_with_http_info(self, owner : Annotated[StrictStr, Field(..., description="Owner of the namespace")], entity : Annotated[StrictStr, Field(..., description="Entity: project name, hub name, registry name, ...")], uuid : Annotated[StrictStr, Field(..., description="Uuid identifier of the sub-entity")], body : V1OwnerSubEntityResourcePromoteRequest, **kwargs):  # noqa: E501
        """Promote project search  # noqa: E501
