...
class V1ProjectSettings(BaseModel):
    ...
    restrictions_template: Optional[StrictStr] = None
    __properties = ["connections", "preset", "presets", "queue", "queues", "agents", "namespaces", "user_accesses", "teams", "projects", "restrictions_template"]
    ...
    def from_dict(cls, obj: dict) -> V1ProjectSettings:
        ...
        _obj = V1ProjectSettings.parse_obj({
            ...
            "restrictions_template": obj.get("restrictions_template")
        })
        return _obj
