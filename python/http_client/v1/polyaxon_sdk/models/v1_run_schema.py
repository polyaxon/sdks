...
class V1RunSchema(object):
    ...
    def __init__(self, job=None, service=None, dag=None, tf_job=None, pytorch_job=None, mpi_job=None, mx_job=None, xgboost_job=None, paddle_job=None, dask=None, spark=None, flink=None, ruy=None, local_vars_configuration=None):  # noqa: E501
    ...
    @property
    def paddle_job(self):
        """Gets the paddle_job of this V1RunSchema.  # noqa: E501


        :return: The paddle_job of this V1RunSchema.  # noqa: E501
        :rtype: V1PaddleJob
        """
        return self._paddle_job

    @paddle_job.setter
    def paddle_job(self, paddle_job):
        """Sets the paddle_job of this V1RunSchema.


        :param paddle_job: The paddle_job of this V1RunSchema.  # noqa: E501
        :type paddle_job: V1PaddleJob
        """

        self._paddle_job = paddle_job
