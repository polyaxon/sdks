...
class V1SparkJob(BaseModel):
    ...
    deploy_mode: Optional[SparkJobDeployMode] = Field(None, alias="deployMode")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> V1SparkJob:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> V1SparkJob:
