...
class V1Policy(BaseModel):
    ...
    projects_settings: Optional[conlist(StrictStr)] = None
    __properties = ["uuid", "owner", "name", "description", "tags", "created_at", "updated_at", "excluded_features", "excluded_runtimes", "archived_deletion_interval", "connections", "preset", "presets", "queue", "queues", "agents", "namespaces", "teams", "projects", "projects_settings"]
    ...
    def from_dict(cls, obj: dict) -> V1Policy:
        ...
        _obj = V1Policy.parse_obj({
            ...
            "projects_settings": obj.get("projects_settings")
        })
        return _obj
