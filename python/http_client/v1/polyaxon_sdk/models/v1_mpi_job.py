...
class V1MPIJob(object):
    ...
    def __init__(self, kind='mpi_job', clean_pod_policy=None, scheduling_policy=None, slots_per_worker=None, worker=None, launcher=None, local_vars_configuration=None):  # noqa: E501
