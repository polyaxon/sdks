...
class V1Operation(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> V1Operation:
        ...
        _obj = V1Operation.parse_obj({
            ...
            "joins": dict((_k, Dict[str, V1Join].from_dict(_v)) for _k, _v in obj.get("joins").items()),
            "params": dict((_k, Dict[str, V1Param].from_dict(_v)) for _k, _v in obj.get("params").items()),
