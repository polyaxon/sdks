...
class V1Environment(BaseModel):
    ...
    tolerations: Optional[List[Dict[str, Any]]] = Field(None, description="Optional Tolerations to apply.")
    ...
    host_aliases: Optional[List[Dict[str, Any]]] = Field(None, alias="hostAliases", description="Optional HostAliases is an optional list of hosts and IPs that will be injected into the pod spec.")
    security_context: Optional[Dict[str, Any]] = Field(None, alias="securityContext")
    image_pull_secrets: Optional[List[StrictStr]] = Field(None, alias="imagePullSecrets")
