...
class V1PolyaxonSidecarContainer(BaseModel):
    ...
    no_connections: Optional[StrictBool] = Field(None, alias="noConnections")
    resources: Optional[Dict[str, Any]] = None
    __properties = ["image", "imageTag", "imagePullPolicy", "sleepInterval", "syncInterval", "monitorLogs", "monitorSpec", "noConnections", "resources"]
    ...
    def from_dict(cls, obj: dict) -> V1PolyaxonSidecarContainer:
        ...
        _obj = V1PolyaxonSidecarContainer.parse_obj({
            ...
            "no_connections": obj.get("noConnections"),
