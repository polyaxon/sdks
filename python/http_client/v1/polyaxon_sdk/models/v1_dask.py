...
class V1Dask(BaseModel):
    """NOTE: This class is auto generated by OpenAPI Generator.
    Ref: https://openapi-generator.tech

    Do not edit the class manually.
    """
    kind: Optional[StrictStr] = 'dask'
    threads: Optional[StrictInt] = None
    scale: Optional[StrictInt] = None
    adapt_min: Optional[StrictInt] = Field(None, alias="adaptMin")
    adapt_max: Optional[StrictInt] = Field(None, alias="adaptMax")
    adapt_interval: Optional[StrictStr] = Field(None, alias="adaptInterval")
    environment: Optional[V1Environment] = None
    connections: Optional[List[StrictStr]] = None
    volumes: Optional[List[Dict[str, Any]]] = Field(None, description="Volumes is a list of volumes that can be mounted.")
    init: Optional[List[V1Init]] = None
    sidecars: Optional[List[Dict[str, Any]]] = None
    container: Optional[Dict[str, Any]] = None
    __properties = ["kind", "threads", "scale", "adaptMin", "adaptMax", "adaptInterval", "environment", "connections", "volumes", "init", "sidecars", "container"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> V1Dask:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> V1Dask:
        """Create an instance of V1Dask from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return V1Dask.parse_obj(obj)

        _obj = V1Dask.parse_obj({
            "kind": obj.get("kind") if obj.get("kind") is not None else 'dask',
            "threads": obj.get("threads"),
            "scale": obj.get("scale"),
            "adapt_min": obj.get("adaptMin"),
            "adapt_max": obj.get("adaptMax"),
            "adapt_interval": obj.get("adaptInterval"),
