...
class V1Agent(BaseModel):
    ...
    __properties = ["uuid", "name", "description", "tags", "live_state", "user", "namespace", "version_api", "version", "content", "created_at", "updated_at", "status", "status_conditions", "is_ui_managed", "hostname", "settings", "stats", "contributors"]
