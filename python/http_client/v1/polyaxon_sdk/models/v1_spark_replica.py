...
class V1SparkReplica(BaseModel):
    """
    V1SparkReplica
    """
    ...
    __properties = ["replicas", "environment", "init", "sidecars", "container"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> V1SparkReplica:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> V1SparkReplica:
        """Create an instance of V1SparkReplica from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return V1SparkReplica.parse_obj(obj)

        _obj = V1SparkReplica.parse_obj({
