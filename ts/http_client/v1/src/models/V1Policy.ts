...
export interface V1Policy {
     ...
     * @memberof V1Policy
     */
    projects_settings?: Array<string>;
}
...
export function V1PolicyFromJSONTyped(json: any, ignoreDiscriminator: boolean): V1Policy {
    ...
    return {
        ...
        'projects_settings': !exists(json, 'projects_settings') ? undefined : json['projects_settings'],
    };
}
...
export function V1PolicyToJSON(value?: V1Policy | null): any {
    ...
    return {
        ...
        'projects_settings': value.projects_settings,
    };
}
