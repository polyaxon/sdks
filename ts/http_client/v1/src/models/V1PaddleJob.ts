...
import type { V1PaddleElasticPolic } from './V1PaddleElasticPolic';
import {
    V1PaddleElasticPolicFromJSON,
    V1PaddleElasticPolicFromJSONTyped,
    V1PaddleElasticPolicToJSON,
} from './V1PaddleElasticPolic';
...
export interface V1PaddleJob {
    ...
    /**
     *
     * @type {V1PaddleElasticPolic}
     * @memberof V1PaddleJob
     */
    elasticPolicy?: V1PaddleElasticPolic;
    /**
     *
     * @type {V1KFReplica}
     * @memberof V1PaddleJob
...
export function V1PaddleJobFromJSONTyped(json: any, ignoreDiscriminator: boolean): V1PaddleJob {
    ...
    return {
        ...
        'elasticPolicy': !exists(json, 'elasticPolicy') ? undefined : V1PaddleElasticPolicFromJSON(json['elasticPolicy']),
...
export function V1PaddleJobToJSON(value?: V1PaddleJob | null): any {
    ...
    return {
        ...
        'elasticPolicy': V1PaddleElasticPolicToJSON(value.elasticPolicy),
