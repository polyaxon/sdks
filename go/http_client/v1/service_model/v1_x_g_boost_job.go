...
func (m *V1XGBoostJob) validateTemplate(formats strfmt.Registry) error {
...
func (m *V1XGBoostJob) contextValidateTemplate(ctx context.Context, formats strfmt.Registry) error {
