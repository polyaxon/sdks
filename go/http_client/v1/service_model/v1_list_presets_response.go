...
func (m *V1ListPresetsResponse) validateResults(formats strfmt.Registry) error {
...
func (m *V1ListPresetsResponse) contextValidateResults(ctx context.Context, formats strfmt.Registry) error {
