...
func (m *V1ListModelVersionsResponse) validateResults(formats strfmt.Registry) error {
...
func (m *V1ListModelVersionsResponse) contextValidateResults(ctx context.Context, formats strfmt.Registry) error {
