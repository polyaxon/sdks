...
func (m *V1ListTokenResponse) validateResults(formats strfmt.Registry) error {
...
func (m *V1ListTokenResponse) contextValidateResults(ctx context.Context, formats strfmt.Registry) error {
