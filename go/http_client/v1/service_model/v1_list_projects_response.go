...
// V1ListProjectsResponse Contains list of projects
//
...
func (m *V1ListProjectsResponse) validateResults(formats strfmt.Registry) error {
...
func (m *V1ListProjectsResponse) contextValidateResults(ctx context.Context, formats strfmt.Registry) error {
...
func (m *V1ListProjectsResponse) UnmarshalBinary(b []byte) error {
	var res V1ListProjectsResponse
