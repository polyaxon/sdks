...
func (m *V1OptimizationResource) validateType(formats strfmt.Registry) error {
...
func (m *V1OptimizationResource) contextValidateType(ctx context.Context, formats strfmt.Registry) error {
...
func (m *V1OptimizationResource) UnmarshalBinary(b []byte) error {
	var res V1OptimizationResource
