...
func (m *V1KFReplica) validateEnvironment(formats strfmt.Registry) error {
...
func (m *V1KFReplica) validateInit(formats strfmt.Registry) error {
...
func (m *V1KFReplica) contextValidateInit(ctx context.Context, formats strfmt.Registry) error {
