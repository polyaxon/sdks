...
func (m *V1ListActivitiesResponse) validateResults(formats strfmt.Registry) error {
...
func (m *V1ListActivitiesResponse) contextValidateResults(ctx context.Context, formats strfmt.Registry) error {
...
func (m *V1ListActivitiesResponse) UnmarshalBinary(b []byte) error {
	var res V1ListActivitiesResponse
