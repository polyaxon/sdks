...
func (m *V1ListModelRegistriesResponse) validateResults(formats strfmt.Registry) error {
...
func (m *V1ListModelRegistriesResponse) contextValidateResults(ctx context.Context, formats strfmt.Registry) error {
...
func (m *V1ListModelRegistriesResponse) UnmarshalBinary(b []byte) error {
	var res V1ListModelRegistriesResponse
