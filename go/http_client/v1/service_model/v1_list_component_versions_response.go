...
// V1ListComponentVersionsResponse Contains list of component hub
//
...
func (m *V1ListComponentVersionsResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *V1ListComponentVersionsResponse) validateResults(formats strfmt.Registry) error {
...
func (m *V1ListComponentVersionsResponse) contextValidateResults(ctx context.Context, formats strfmt.Registry) error {
...
func (m *V1ListComponentVersionsResponse) UnmarshalBinary(b []byte) error {
	var res V1ListComponentVersionsResponse
