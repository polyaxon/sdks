...
// V1ListQueuesResponse Contains list of agents
//
...
func (m *V1ListQueuesResponse) validateResults(formats strfmt.Registry) error {
...
func (m *V1ListQueuesResponse) contextValidateResults(ctx context.Context, formats strfmt.Registry) error {
