...
// V1ListAgentsResponse Contains list of agents
//
...
func (m *V1ListAgentsResponse) validateResults(formats strfmt.Registry) error {
...
func (m *V1ListAgentsResponse) contextValidateResults(ctx context.Context, formats strfmt.Registry) error {
