...
func (m *V1ListRunArtifactsResponse) validateResults(formats strfmt.Registry) error {
...
func (m *V1ListRunArtifactsResponse) contextValidateResults(ctx context.Context, formats strfmt.Registry) error {
...
func (m *V1ListRunArtifactsResponse) UnmarshalBinary(b []byte) error {
	var res V1ListRunArtifactsResponse
