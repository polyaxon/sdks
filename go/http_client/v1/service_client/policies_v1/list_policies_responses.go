...
func (o *ListPoliciesOK) Error() string {
	return fmt.Sprintf("[GET /api/v1/orgs/{owner}/policies][%d] listPoliciesOK  %+v", 200, o.Payload)
}
...
func (o *ListPoliciesNoContent) Error() string {
	return fmt.Sprintf("[GET /api/v1/orgs/{owner}/policies][%d] listPoliciesNoContent  %+v", 204, o.Payload)
}
...
func (o *ListPoliciesForbidden) Error() string {
	return fmt.Sprintf("[GET /api/v1/orgs/{owner}/policies][%d] listPoliciesForbidden  %+v", 403, o.Payload)
}
...
func (o *ListPoliciesNotFound) Error() string {
	return fmt.Sprintf("[GET /api/v1/orgs/{owner}/policies][%d] listPoliciesNotFound  %+v", 404, o.Payload)
}
...
func (o *ListPoliciesDefault) Error() string {
	return fmt.Sprintf("[GET /api/v1/orgs/{owner}/policies][%d] ListPolicies default  %+v", o._statusCode, o.Payload)
}
