...
func (o *ListOrganizationQueueNamesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *ListOrganizationQueueNamesOK) Error() string {
	...
	return fmt.Sprintf("[GET /api/v1/orgs/{owner}/queues/names][%d] listOrganizationQueueNamesOK %s", 200, payload)
}
...
func (o *ListOrganizationQueueNamesNoContent) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/orgs/{owner}/queues/names][%d] listOrganizationQueueNamesNoContent %s", 204, payload)
}
...
func (o *ListOrganizationQueueNamesNoContent) GetPayload() any {
	return o.Payload
}
...
func (o *ListOrganizationQueueNamesForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/orgs/{owner}/queues/names][%d] listOrganizationQueueNamesForbidden %s", 403, payload)
}
...
func (o *ListOrganizationQueueNamesForbidden) GetPayload() any {
	return o.Payload
}
...
func (o *ListOrganizationQueueNamesNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/orgs/{owner}/queues/names][%d] listOrganizationQueueNamesNotFound %s", 404, payload)
}
...
func (o *ListOrganizationQueueNamesNotFound) GetPayload() any {
	return o.Payload
}
...
func (o *ListOrganizationQueueNamesDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/orgs/{owner}/queues/names][%d] ListOrganizationQueueNames default %s", o._statusCode, payload)
}
