...
func (o *PatchServiceAccountReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *PatchServiceAccountOK) Error() string {
	...
	return fmt.Sprintf("[PATCH /api/v1/orgs/{owner}/sa/{sa.uuid}][%d] patchServiceAccountOK %s", 200, payload)
}
...
func (o *PatchServiceAccountNoContent) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PATCH /api/v1/orgs/{owner}/sa/{sa.uuid}][%d] patchServiceAccountNoContent %s", 204, payload)
}
...
func (o *PatchServiceAccountNoContent) GetPayload() any {
	return o.Payload
}
...
func (o *PatchServiceAccountForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PATCH /api/v1/orgs/{owner}/sa/{sa.uuid}][%d] patchServiceAccountForbidden %s", 403, payload)
}
...
func (o *PatchServiceAccountForbidden) GetPayload() any {
	return o.Payload
}
...
func (o *PatchServiceAccountNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PATCH /api/v1/orgs/{owner}/sa/{sa.uuid}][%d] patchServiceAccountNotFound %s", 404, payload)
}
...
func (o *PatchServiceAccountNotFound) GetPayload() any {
	return o.Payload
}
...
func (o *PatchServiceAccountDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PATCH /api/v1/orgs/{owner}/sa/{sa.uuid}][%d] PatchServiceAccount default %s", o._statusCode, payload)
}
