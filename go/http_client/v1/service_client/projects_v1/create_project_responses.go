...
func (o *CreateProjectOK) Error() string {
	...
	return fmt.Sprintf("[POST /api/v1/{owner}/projects/create][%d] createProjectOK %s", 200, payload)
}
...
func (o *CreateProjectNoContent) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/{owner}/projects/create][%d] createProjectNoContent %s", 204, payload)
}
...
func (o *CreateProjectNoContent) GetPayload() any {
	return o.Payload
}
...
func (o *CreateProjectForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/{owner}/projects/create][%d] createProjectForbidden %s", 403, payload)
}
...
func (o *CreateProjectForbidden) GetPayload() any {
	return o.Payload
}
...
func (o *CreateProjectNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/{owner}/projects/create][%d] createProjectNotFound %s", 404, payload)
}
...
func (o *CreateProjectNotFound) GetPayload() any {
	return o.Payload
}
...
func (o *CreateProjectDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/{owner}/projects/create][%d] CreateProject default %s", o._statusCode, payload)
}
