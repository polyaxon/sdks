...
func (o *CreateOrganizationOK) Error() string {
	...
	return fmt.Sprintf("[POST /api/v1/orgs/create][%d] createOrganizationOK %s", 200, payload)
}
...
func (o *CreateOrganizationNoContent) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/orgs/create][%d] createOrganizationNoContent %s", 204, payload)
}
...
func (o *CreateOrganizationNoContent) GetPayload() any {
	return o.Payload
}
...
func (o *CreateOrganizationForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/orgs/create][%d] createOrganizationForbidden %s", 403, payload)
}
...
func (o *CreateOrganizationForbidden) GetPayload() any {
	return o.Payload
}
...
func (o *CreateOrganizationNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/orgs/create][%d] createOrganizationNotFound %s", 404, payload)
}
...
func (o *CreateOrganizationNotFound) GetPayload() any {
	return o.Payload
}
...
func (o *CreateOrganizationDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/orgs/create][%d] CreateOrganization default %s", o._statusCode, payload)
}
