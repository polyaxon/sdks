...
func (o *ListOrganizationsOK) Error() string {
	...
	return fmt.Sprintf("[GET /api/v1/orgs/list][%d] listOrganizationsOK %s", 200, payload)
}
...
func (o *ListOrganizationsNoContent) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/orgs/list][%d] listOrganizationsNoContent %s", 204, payload)
}
...
func (o *ListOrganizationsNoContent) GetPayload() any {
	return o.Payload
}
...
func (o *ListOrganizationsForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/orgs/list][%d] listOrganizationsForbidden %s", 403, payload)
}
...
func (o *ListOrganizationsForbidden) GetPayload() any {
	return o.Payload
}
...
func (o *ListOrganizationsNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/orgs/list][%d] listOrganizationsNotFound %s", 404, payload)
}
...
func (o *ListOrganizationsNotFound) GetPayload() any {
	return o.Payload
}
...
func (o *ListOrganizationsDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/orgs/list][%d] ListOrganizations default %s", o._statusCode, payload)
}
