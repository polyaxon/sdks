...
func (o *ListOrganizationMemberNamesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *ListOrganizationMemberNamesOK) Error() string {
	...
	return fmt.Sprintf("[GET /api/v1/orgs/{owner}/members/names][%d] listOrganizationMemberNamesOK %s", 200, payload)
}
...
func (o *ListOrganizationMemberNamesNoContent) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/orgs/{owner}/members/names][%d] listOrganizationMemberNamesNoContent %s", 204, payload)
}
...
func (o *ListOrganizationMemberNamesNoContent) GetPayload() any {
	return o.Payload
}
...
func (o *ListOrganizationMemberNamesForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/orgs/{owner}/members/names][%d] listOrganizationMemberNamesForbidden %s", 403, payload)
}
...
func (o *ListOrganizationMemberNamesForbidden) GetPayload() any {
	return o.Payload
}
...
func (o *ListOrganizationMemberNamesNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/orgs/{owner}/members/names][%d] listOrganizationMemberNamesNotFound %s", 404, payload)
}
...
func (o *ListOrganizationMemberNamesNotFound) GetPayload() any {
	return o.Payload
}
...
func (o *ListOrganizationMemberNamesDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/orgs/{owner}/members/names][%d] ListOrganizationMemberNames default %s", o._statusCode, payload)
}
