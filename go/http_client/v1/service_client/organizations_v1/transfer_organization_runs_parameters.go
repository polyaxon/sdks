...
// NewTransferOrganizationRunsParams creates a new TransferOrganizationRunsParams object,
...
func NewTransferOrganizationRunsParams() *TransferOrganizationRunsParams {
	return &TransferOrganizationRunsParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewTransferOrganizationRunsParamsWithTimeout creates a new TransferOrganizationRunsParams object
...
// NewTransferOrganizationRunsParamsWithContext creates a new TransferOrganizationRunsParams object
...
// NewTransferOrganizationRunsParamsWithHTTPClient creates a new TransferOrganizationRunsParams object
...
func (o *TransferOrganizationRunsParams) WithDefaults() *TransferOrganizationRunsParams {
	o.SetDefaults()
	return o
}
...
func (o *TransferOrganizationRunsParams) WithTimeout(timeout time.Duration) *TransferOrganizationRunsParams {
...
func (o *TransferOrganizationRunsParams) WithContext(ctx context.Context) *TransferOrganizationRunsParams {
	o.SetContext(ctx)
	return o
}
...
func (o *TransferOrganizationRunsParams) WithHTTPClient(client *http.Client) *TransferOrganizationRunsParams {
...
func (o *TransferOrganizationRunsParams) WithBody(body *service_model.V1EntitiesTransfer) *TransferOrganizationRunsParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the transfer organization runs params
func (o *TransferOrganizationRunsParams) SetBody(body *service_model.V1EntitiesTransfer) {
	o.Body = body
}

// WithOwner adds the owner to the transfer organization runs params
func (o *TransferOrganizationRunsParams) WithOwner(owner string) *TransferOrganizationRunsParams {
	o.SetOwner(owner)
	return o
}
...
func (o *TransferOrganizationRunsParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
