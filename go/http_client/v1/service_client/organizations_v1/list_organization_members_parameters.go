...
func (o *ListOrganizationMembersParams) WithBookmarks(bookmarks *bool) *ListOrganizationMembersParams {
...
func (o *ListOrganizationMembersParams) WithMode(mode *string) *ListOrganizationMembersParams {
	o.SetMode(mode)
	return o
}
