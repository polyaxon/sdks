...
// NewInvalidateOrganizationRunsParams creates a new InvalidateOrganizationRunsParams object,
...
func NewInvalidateOrganizationRunsParams() *InvalidateOrganizationRunsParams {
	return &InvalidateOrganizationRunsParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewInvalidateOrganizationRunsParamsWithTimeout creates a new InvalidateOrganizationRunsParams object
...
// NewInvalidateOrganizationRunsParamsWithContext creates a new InvalidateOrganizationRunsParams object
...
// NewInvalidateOrganizationRunsParamsWithHTTPClient creates a new InvalidateOrganizationRunsParams object
...
func (o *InvalidateOrganizationRunsParams) WithDefaults() *InvalidateOrganizationRunsParams {
	o.SetDefaults()
	return o
}
...
func (o *InvalidateOrganizationRunsParams) WithTimeout(timeout time.Duration) *InvalidateOrganizationRunsParams {
...
func (o *InvalidateOrganizationRunsParams) WithContext(ctx context.Context) *InvalidateOrganizationRunsParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the invalidate organization runs params
func (o *InvalidateOrganizationRunsParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the invalidate organization runs params
func (o *InvalidateOrganizationRunsParams) WithHTTPClient(client *http.Client) *InvalidateOrganizationRunsParams {
...
func (o *InvalidateOrganizationRunsParams) WithBody(body *service_model.V1Uuids) *InvalidateOrganizationRunsParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the invalidate organization runs params
func (o *InvalidateOrganizationRunsParams) SetBody(body *service_model.V1Uuids) {
	o.Body = body
}

// WithOwner adds the owner to the invalidate organization runs params
func (o *InvalidateOrganizationRunsParams) WithOwner(owner string) *InvalidateOrganizationRunsParams {
	o.SetOwner(owner)
	return o
}
...
func (o *InvalidateOrganizationRunsParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
