...
func (o *TagOrganizationRunsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *TagOrganizationRunsNoContent) Error() string {
	...
	return fmt.Sprintf("[POST /api/v1/orgs/{owner}/runs/tag][%d] tagOrganizationRunsNoContent %s", 204, payload)
}
...
func (o *TagOrganizationRunsNoContent) GetPayload() any {
	return o.Payload
}
...
func (o *TagOrganizationRunsForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/orgs/{owner}/runs/tag][%d] tagOrganizationRunsForbidden %s", 403, payload)
}
...
func (o *TagOrganizationRunsForbidden) GetPayload() any {
	return o.Payload
}
...
func (o *TagOrganizationRunsNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/orgs/{owner}/runs/tag][%d] tagOrganizationRunsNotFound %s", 404, payload)
}
...
func (o *TagOrganizationRunsNotFound) GetPayload() any {
	return o.Payload
}
...
func (o *TagOrganizationRunsDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/orgs/{owner}/runs/tag][%d] TagOrganizationRuns default %s", o._statusCode, payload)
}
