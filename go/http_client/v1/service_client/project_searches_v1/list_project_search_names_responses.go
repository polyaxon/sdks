...
func (o *ListProjectSearchNamesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *ListProjectSearchNamesOK) Error() string {
	...
	return fmt.Sprintf("[GET /api/v1/{owner}/{name}/searches/names][%d] listProjectSearchNamesOK %s", 200, payload)
}
...
func (o *ListProjectSearchNamesNoContent) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/{owner}/{name}/searches/names][%d] listProjectSearchNamesNoContent %s", 204, payload)
}
...
func (o *ListProjectSearchNamesNoContent) GetPayload() any {
	return o.Payload
}
...
func (o *ListProjectSearchNamesForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/{owner}/{name}/searches/names][%d] listProjectSearchNamesForbidden %s", 403, payload)
}
...
func (o *ListProjectSearchNamesForbidden) GetPayload() any {
	return o.Payload
}
...
func (o *ListProjectSearchNamesNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/{owner}/{name}/searches/names][%d] listProjectSearchNamesNotFound %s", 404, payload)
}
...
func (o *ListProjectSearchNamesNotFound) GetPayload() any {
	return o.Payload
}
...
func (o *ListProjectSearchNamesDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/{owner}/{name}/searches/names][%d] ListProjectSearchNames default %s", o._statusCode, payload)
}
