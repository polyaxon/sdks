...
func (o *UpdateProjectSearchReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *UpdateProjectSearchOK) Error() string {
	...
	return fmt.Sprintf("[PUT /api/v1/{owner}/{project}/searches/{search.uuid}][%d] updateProjectSearchOK %s", 200, payload)
}
...
func (o *UpdateProjectSearchNoContent) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/v1/{owner}/{project}/searches/{search.uuid}][%d] updateProjectSearchNoContent %s", 204, payload)
}
...
func (o *UpdateProjectSearchNoContent) GetPayload() any {
	return o.Payload
}
...
func (o *UpdateProjectSearchForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/v1/{owner}/{project}/searches/{search.uuid}][%d] updateProjectSearchForbidden %s", 403, payload)
}
...
func (o *UpdateProjectSearchForbidden) GetPayload() any {
	return o.Payload
}
...
func (o *UpdateProjectSearchNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/v1/{owner}/{project}/searches/{search.uuid}][%d] updateProjectSearchNotFound %s", 404, payload)
}
...
func (o *UpdateProjectSearchNotFound) GetPayload() any {
	return o.Payload
}
...
func (o *UpdateProjectSearchDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/v1/{owner}/{project}/searches/{search.uuid}][%d] UpdateProjectSearch default %s", o._statusCode, payload)
}
