...
// WithBookmarks adds the bookmarks to the list project searches params
func (o *ListProjectSearchesParams) WithBookmarks(bookmarks *bool) *ListProjectSearchesParams {
	o.SetBookmarks(bookmarks)
	return o
}

// SetBookmarks adds the bookmarks to the list project searches params
func (o *ListProjectSearchesParams) SetBookmarks(bookmarks *bool) {
