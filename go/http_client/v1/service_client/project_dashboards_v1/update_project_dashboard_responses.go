...
func (o *UpdateProjectDashboardReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *UpdateProjectDashboardOK) Error() string {
	...
	return fmt.Sprintf("[PUT /api/v1/{owner}/{project}/dashboards/{dashboard.uuid}][%d] updateProjectDashboardOK %s", 200, payload)
}
...
func (o *UpdateProjectDashboardNoContent) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/v1/{owner}/{project}/dashboards/{dashboard.uuid}][%d] updateProjectDashboardNoContent %s", 204, payload)
}
...
func (o *UpdateProjectDashboardNoContent) GetPayload() any {
	return o.Payload
}
...
func (o *UpdateProjectDashboardForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/v1/{owner}/{project}/dashboards/{dashboard.uuid}][%d] updateProjectDashboardForbidden %s", 403, payload)
}
...
func (o *UpdateProjectDashboardForbidden) GetPayload() any {
	return o.Payload
}
...
func (o *UpdateProjectDashboardNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/v1/{owner}/{project}/dashboards/{dashboard.uuid}][%d] updateProjectDashboardNotFound %s", 404, payload)
}
...
func (o *UpdateProjectDashboardNotFound) GetPayload() any {
	return o.Payload
}
...
func (o *UpdateProjectDashboardDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/v1/{owner}/{project}/dashboards/{dashboard.uuid}][%d] UpdateProjectDashboard default %s", o._statusCode, payload)
}
