...
// WithRun adds the run to the list project dashboard names params
func (o *ListProjectDashboardNamesParams) WithRun(run *string) *ListProjectDashboardNamesParams {
	o.SetRun(run)
	return o
}

// SetRun adds the run to the list project dashboard names params
func (o *ListProjectDashboardNamesParams) SetRun(run *string) {
	o.Run = run
}
