...
func (o *CreateProjectDashboardReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *CreateProjectDashboardOK) Error() string {
	...
	return fmt.Sprintf("[POST /api/v1/{owner}/{project}/dashboards][%d] createProjectDashboardOK %s", 200, payload)
}
...
func (o *CreateProjectDashboardNoContent) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/{owner}/{project}/dashboards][%d] createProjectDashboardNoContent %s", 204, payload)
}
...
func (o *CreateProjectDashboardNoContent) GetPayload() any {
	return o.Payload
}
...
func (o *CreateProjectDashboardForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/{owner}/{project}/dashboards][%d] createProjectDashboardForbidden %s", 403, payload)
}
...
func (o *CreateProjectDashboardForbidden) GetPayload() any {
	return o.Payload
}
...
func (o *CreateProjectDashboardNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/{owner}/{project}/dashboards][%d] createProjectDashboardNotFound %s", 404, payload)
}
...
func (o *CreateProjectDashboardNotFound) GetPayload() any {
	return o.Payload
}
...
func (o *CreateProjectDashboardDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/{owner}/{project}/dashboards][%d] CreateProjectDashboard default %s", o._statusCode, payload)
}
