...
func (o *GetAgentOK) Error() string {
	...
	return fmt.Sprintf("[GET /api/v1/orgs/{owner}/agents/{uuid}][%d] getAgentOK %s", 200, payload)
}
...
func (o *GetAgentNoContent) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/orgs/{owner}/agents/{uuid}][%d] getAgentNoContent %s", 204, payload)
}
...
func (o *GetAgentNoContent) GetPayload() any {
	return o.Payload
}
...
func (o *GetAgentForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/orgs/{owner}/agents/{uuid}][%d] getAgentForbidden %s", 403, payload)
}
...
func (o *GetAgentForbidden) GetPayload() any {
	return o.Payload
}
...
func (o *GetAgentNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/orgs/{owner}/agents/{uuid}][%d] getAgentNotFound %s", 404, payload)
}
...
func (o *GetAgentNotFound) GetPayload() any {
	return o.Payload
}
...
func (o *GetAgentDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/orgs/{owner}/agents/{uuid}][%d] GetAgent default %s", o._statusCode, payload)
}
