...
// NewListAgentNamesParams creates a new ListAgentNamesParams object,
...
func NewListAgentNamesParams() *ListAgentNamesParams {
	return &ListAgentNamesParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewListAgentNamesParamsWithTimeout creates a new ListAgentNamesParams object
...
// NewListAgentNamesParamsWithContext creates a new ListAgentNamesParams object
...
// NewListAgentNamesParamsWithHTTPClient creates a new ListAgentNamesParams object
...
func (o *ListAgentNamesParams) WithContext(ctx context.Context) *ListAgentNamesParams {
	o.SetContext(ctx)
	return o
}
...
// WithBookmarks adds the bookmarks to the list agent names params
func (o *ListAgentNamesParams) WithBookmarks(bookmarks *bool) *ListAgentNamesParams {
	o.SetBookmarks(bookmarks)
	return o
}

// SetBookmarks adds the bookmarks to the list agent names params
func (o *ListAgentNamesParams) SetBookmarks(bookmarks *bool) {
...
// WithMode adds the mode to the list agent names params
func (o *ListAgentNamesParams) WithMode(mode *string) *ListAgentNamesParams {
	o.SetMode(mode)
	return o
}

// SetMode adds the mode to the list agent names params
func (o *ListAgentNamesParams) SetMode(mode *string) {
	o.Mode = mode
}
