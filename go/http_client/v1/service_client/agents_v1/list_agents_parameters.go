...
// WithBookmarks adds the bookmarks to the list agents params
func (o *ListAgentsParams) WithBookmarks(bookmarks *bool) *ListAgentsParams {
	o.SetBookmarks(bookmarks)
	return o
}

// SetBookmarks adds the bookmarks to the list agents params
func (o *ListAgentsParams) SetBookmarks(bookmarks *bool) {
...
// WithMode adds the mode to the list agents params
func (o *ListAgentsParams) WithMode(mode *string) *ListAgentsParams {
	o.SetMode(mode)
	return o
}

// SetMode adds the mode to the list agents params
func (o *ListAgentsParams) SetMode(mode *string) {
	o.Mode = mode
}
