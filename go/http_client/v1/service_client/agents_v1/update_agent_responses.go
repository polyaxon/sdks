...
func (o *UpdateAgentReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *UpdateAgentOK) Error() string {
	...
	return fmt.Sprintf("[PUT /api/v1/orgs/{owner}/agents/{agent.uuid}][%d] updateAgentOK %s", 200, payload)
}
...
func (o *UpdateAgentNoContent) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/v1/orgs/{owner}/agents/{agent.uuid}][%d] updateAgentNoContent %s", 204, payload)
}
...
func (o *UpdateAgentNoContent) GetPayload() any {
	return o.Payload
}
...
func (o *UpdateAgentForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/v1/orgs/{owner}/agents/{agent.uuid}][%d] updateAgentForbidden %s", 403, payload)
}
...
func (o *UpdateAgentForbidden) GetPayload() any {
	return o.Payload
}
...
func (o *UpdateAgentNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/v1/orgs/{owner}/agents/{agent.uuid}][%d] updateAgentNotFound %s", 404, payload)
}
...
func (o *UpdateAgentNotFound) GetPayload() any {
	return o.Payload
}
...
func (o *UpdateAgentDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/v1/orgs/{owner}/agents/{agent.uuid}][%d] UpdateAgent default %s", o._statusCode, payload)
}
