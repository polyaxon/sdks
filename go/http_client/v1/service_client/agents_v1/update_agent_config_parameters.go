...
// NewUpdateAgentConfigParams creates a new UpdateAgentConfigParams object,
...
func NewUpdateAgentConfigParams() *UpdateAgentConfigParams {
	return &UpdateAgentConfigParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewUpdateAgentConfigParamsWithTimeout creates a new UpdateAgentConfigParams object
...
// NewUpdateAgentConfigParamsWithContext creates a new UpdateAgentConfigParams object
...
// NewUpdateAgentConfigParamsWithHTTPClient creates a new UpdateAgentConfigParams object
...
func (o *UpdateAgentConfigParams) WithDefaults() *UpdateAgentConfigParams {
	o.SetDefaults()
	return o
}
...
func (o *UpdateAgentConfigParams) WithTimeout(timeout time.Duration) *UpdateAgentConfigParams {
...
func (o *UpdateAgentConfigParams) WithContext(ctx context.Context) *UpdateAgentConfigParams {
	o.SetContext(ctx)
	return o
}
...
func (o *UpdateAgentConfigParams) WithBody(body *service_model.V1Agent) *UpdateAgentConfigParams {
	o.SetBody(body)
	return o
}
...
func (o *UpdateAgentConfigParams) WithOwner(owner string) *UpdateAgentConfigParams {
	o.SetOwner(owner)
	return o
}
...
func (o *UpdateAgentConfigParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
