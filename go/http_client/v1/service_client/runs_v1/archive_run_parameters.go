...
// WithDefaults hydrates default values in the archive run params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *ArchiveRunParams) WithDefaults() *ArchiveRunParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the archive run params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *ArchiveRunParams) SetDefaults() {
