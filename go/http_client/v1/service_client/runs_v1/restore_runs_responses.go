...
func (o *RestoreRunsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *RestoreRunsNoContent) Error() string {
	...
	return fmt.Sprintf("[POST /api/v1/{owner}/{name}/runs/restore][%d] restoreRunsNoContent %s", 204, payload)
}
...
func (o *RestoreRunsNoContent) GetPayload() any {
	return o.Payload
}
...
func (o *RestoreRunsForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/{owner}/{name}/runs/restore][%d] restoreRunsForbidden %s", 403, payload)
}
...
func (o *RestoreRunsForbidden) GetPayload() any {
	return o.Payload
}
...
func (o *RestoreRunsNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/{owner}/{name}/runs/restore][%d] restoreRunsNotFound %s", 404, payload)
}
...
func (o *RestoreRunsNotFound) GetPayload() any {
	return o.Payload
}
...
func (o *RestoreRunsDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/{owner}/{name}/runs/restore][%d] RestoreRuns default %s", o._statusCode, payload)
}
