...
// WithProject adds the project to the skip runs params
func (o *SkipRunsParams) WithProject(project string) *SkipRunsParams {
	o.SetProject(project)
	return o
}

// SetProject adds the project to the skip runs params
func (o *SkipRunsParams) SetProject(project string) {
	o.Project = project
}
