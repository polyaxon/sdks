...
func (o *ResumeRunOK) Error() string {
	...
	return fmt.Sprintf("[POST /api/v1/{owner}/{project}/runs/{run.uuid}/resume][%d] resumeRunOK %s", 200, payload)
}
...
func (o *ResumeRunNoContent) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/{owner}/{project}/runs/{run.uuid}/resume][%d] resumeRunNoContent %s", 204, payload)
}
...
func (o *ResumeRunNoContent) GetPayload() any {
	return o.Payload
}
...
func (o *ResumeRunForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/{owner}/{project}/runs/{run.uuid}/resume][%d] resumeRunForbidden %s", 403, payload)
}
...
func (o *ResumeRunForbidden) GetPayload() any {
	return o.Payload
}
...
func (o *ResumeRunNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/{owner}/{project}/runs/{run.uuid}/resume][%d] resumeRunNotFound %s", 404, payload)
}
...
func (o *ResumeRunNotFound) GetPayload() any {
	return o.Payload
}
...
func (o *ResumeRunDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/{owner}/{project}/runs/{run.uuid}/resume][%d] ResumeRun default %s", o._statusCode, payload)
}
