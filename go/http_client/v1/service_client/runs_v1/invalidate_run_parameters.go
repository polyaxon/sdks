...
InvalidateRunParams contains all the parameters to send to the API endpoint
	...
	for the invalidate run operation.
...
// WithDefaults hydrates default values in the invalidate run params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *InvalidateRunParams) WithDefaults() *InvalidateRunParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the invalidate run params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *InvalidateRunParams) SetDefaults() {
...
// WithEntity adds the entity to the invalidate run params
func (o *InvalidateRunParams) WithEntity(entity string) *InvalidateRunParams {
	o.SetEntity(entity)
	return o
}

// SetEntity adds the entity to the invalidate run params
func (o *InvalidateRunParams) SetEntity(entity string) {
	o.Entity = entity
}
