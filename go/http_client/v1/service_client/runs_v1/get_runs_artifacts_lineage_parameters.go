...
/* GetRunsArtifactsLineageParams contains all the parameters to send to the API endpoint
   for the get runs artifacts lineage operation.
...
// WithDefaults hydrates default values in the get runs artifacts lineage params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetRunsArtifactsLineageParams) WithDefaults() *GetRunsArtifactsLineageParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the get runs artifacts lineage params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetRunsArtifactsLineageParams) SetDefaults() {
...
// WithMode adds the mode to the get runs artifacts lineage params
func (o *GetRunsArtifactsLineageParams) WithMode(mode *string) *GetRunsArtifactsLineageParams {
	o.SetMode(mode)
	return o
}

// SetMode adds the mode to the get runs artifacts lineage params
func (o *GetRunsArtifactsLineageParams) SetMode(mode *string) {
	o.Mode = mode
}
