...
func (o *GetSearchOK) Error() string {
	...
	return fmt.Sprintf("[GET /api/v1/orgs/{owner}/searches/{uuid}][%d] getSearchOK %s", 200, payload)
}
...
func (o *GetSearchNoContent) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/orgs/{owner}/searches/{uuid}][%d] getSearchNoContent %s", 204, payload)
}
...
func (o *GetSearchNoContent) GetPayload() any {
	return o.Payload
}
...
func (o *GetSearchForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/orgs/{owner}/searches/{uuid}][%d] getSearchForbidden %s", 403, payload)
}
...
func (o *GetSearchForbidden) GetPayload() any {
	return o.Payload
}
...
func (o *GetSearchNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/orgs/{owner}/searches/{uuid}][%d] getSearchNotFound %s", 404, payload)
}
...
func (o *GetSearchNotFound) GetPayload() any {
	return o.Payload
}
...
func (o *GetSearchDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/orgs/{owner}/searches/{uuid}][%d] GetSearch default %s", o._statusCode, payload)
}
