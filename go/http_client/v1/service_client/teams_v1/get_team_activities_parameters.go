...
// NewGetTeamActivitiesParams creates a new GetTeamActivitiesParams object,
...
func NewGetTeamActivitiesParams() *GetTeamActivitiesParams {
	return &GetTeamActivitiesParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewGetTeamActivitiesParamsWithTimeout creates a new GetTeamActivitiesParams object
...
// NewGetTeamActivitiesParamsWithContext creates a new GetTeamActivitiesParams object
...
// NewGetTeamActivitiesParamsWithHTTPClient creates a new GetTeamActivitiesParams object
...
func (o *GetTeamActivitiesParams) WithDefaults() *GetTeamActivitiesParams {
	o.SetDefaults()
	return o
}
...
func (o *GetTeamActivitiesParams) WithTimeout(timeout time.Duration) *GetTeamActivitiesParams {
...
func (o *GetTeamActivitiesParams) WithContext(ctx context.Context) *GetTeamActivitiesParams {
	o.SetContext(ctx)
	return o
}
...
func (o *GetTeamActivitiesParams) WithLimit(limit *int32) *GetTeamActivitiesParams {
	o.SetLimit(limit)
	return o
}
...
func (o *GetTeamActivitiesParams) WithMode(mode *string) *GetTeamActivitiesParams {
	o.SetMode(mode)
	return o
}
...
func (o *GetTeamActivitiesParams) WithName(name string) *GetTeamActivitiesParams {
	o.SetName(name)
	return o
}
...
func (o *GetTeamActivitiesParams) WithOwner(owner string) *GetTeamActivitiesParams {
	o.SetOwner(owner)
	return o
}
...
func (o *GetTeamActivitiesParams) WithQuery(query *string) *GetTeamActivitiesParams {
	o.SetQuery(query)
	return o
}
...
func (o *GetTeamActivitiesParams) WithSort(sort *string) *GetTeamActivitiesParams {
	o.SetSort(sort)
	return o
}
...
func (o *GetTeamActivitiesParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
