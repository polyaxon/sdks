...
func (o *UpdateDashboardOK) Error() string {
	...
	return fmt.Sprintf("[PUT /api/v1/orgs/{owner}/dashboards/{dashboard.uuid}][%d] updateDashboardOK %s", 200, payload)
}
...
func (o *UpdateDashboardNoContent) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/v1/orgs/{owner}/dashboards/{dashboard.uuid}][%d] updateDashboardNoContent %s", 204, payload)
}
...
func (o *UpdateDashboardNoContent) GetPayload() any {
	return o.Payload
}
...
func (o *UpdateDashboardForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/v1/orgs/{owner}/dashboards/{dashboard.uuid}][%d] updateDashboardForbidden %s", 403, payload)
}
...
func (o *UpdateDashboardForbidden) GetPayload() any {
	return o.Payload
}
...
func (o *UpdateDashboardNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/v1/orgs/{owner}/dashboards/{dashboard.uuid}][%d] updateDashboardNotFound %s", 404, payload)
}
...
func (o *UpdateDashboardNotFound) GetPayload() any {
	return o.Payload
}
...
func (o *UpdateDashboardDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/v1/orgs/{owner}/dashboards/{dashboard.uuid}][%d] UpdateDashboard default %s", o._statusCode, payload)
}
