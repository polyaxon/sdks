if [ $? -eq 0 ]; then
    if [ "$1" = "sync" ]; then
        ...
        rm python/http_client/v1/polyaxon_sdk/configuration.py python/http_client/v1/polyaxon_sdk/sync_client/
    elif [ "$1" = "async" ]; then
        ...
        rm python/http_client/v1/polyaxon_sdk/configuration.py python/http_client/v1/polyaxon_sdk/async_client/
    fi
fi
