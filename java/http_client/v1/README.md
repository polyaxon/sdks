...
```groovy
  ...
  dependencies {
     implementation "org.openapitools:openapi-java-client:2.0.0-rc54"
  }
```
...
* `target/openapi-java-client-2.0.0-rc54.jar`
* `target/lib/*.jar`
