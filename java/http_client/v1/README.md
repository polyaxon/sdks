...
```groovy
  ...
  dependencies {
     implementation "org.openapitools:openapi-java-client:2.1.0-rc12"
  }
```
...
* `target/openapi-java-client-2.1.0-rc12.jar`
* `target/lib/*.jar`
