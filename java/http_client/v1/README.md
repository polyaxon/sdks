...
```groovy
  ...
  dependencies {
     implementation "org.openapitools:openapi-java-client:2.1.0-rc17"
  }
```
...
* `target/openapi-java-client-2.1.0-rc17.jar`
* `target/lib/*.jar`
