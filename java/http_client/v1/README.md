...
```groovy
  ...
  dependencies {
     implementation "org.openapitools:openapi-java-client:2.1.0-rc16"
  }
```
...
* `target/openapi-java-client-2.1.0-rc16.jar`
* `target/lib/*.jar`
...
*RunsV1Api* | [**skipRuns**](docs/RunsV1Api.md#skipRuns) | **POST** /api/v1/{owner}/{project}/runs/skip | Skip runs
