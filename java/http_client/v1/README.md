...
```groovy
  ...
  dependencies {
     implementation "org.openapitools:openapi-java-client:2.0.0-rc39"
  }
```
...
* `target/openapi-java-client-2.0.0-rc39.jar`
* `target/lib/*.jar`
