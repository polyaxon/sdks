...
```groovy
  ...
  dependencies {
     implementation "org.openapitools:openapi-java-client:2.0.0-rc50"
  }
```
...
* `target/openapi-java-client-2.0.0-rc50.jar`
* `target/lib/*.jar`
