...
# **listDashboardNames**
> V1ListDashboardsResponse listDashboardNames(owner, offset, limit, sort, query, bookmarks, mode, noPage)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      V1ListDashboardsResponse result = apiInstance.listDashboardNames(owner, offset, limit, sort, query, bookmarks, mode, noPage);
      System.out.println(result);
    } catch (ApiException e) {
...
# **listDashboards**
> V1ListDashboardsResponse listDashboards(owner, offset, limit, sort, query, bookmarks, mode, noPage)
...
public class Example {
  public static void main(String[] args) {
    ...
    Boolean noPage = true; // Boolean | No pagination.
    try {
      V1ListDashboardsResponse result = apiInstance.listDashboards(owner, offset, limit, sort, query, bookmarks, mode, noPage);
      System.out.println(result);
    } catch (ApiException e) {
