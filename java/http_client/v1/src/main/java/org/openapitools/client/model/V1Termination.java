...
import org.openapitools.client.model.V1ActivityProbe;
import org.openapitools.client.model.V1Culling;
...
public class V1Termination {
  ...
  public static final String SERIALIZED_NAME_CULLING = "culling";
  @SerializedName(SERIALIZED_NAME_CULLING)
  private V1Culling culling;
  ...
  **/
  ...
  public V1Culling getCulling() {
    return culling;
  }


  public void setCulling(V1Culling culling) {
    this.culling = culling;
  }
  ...
  **/
  ...
  public V1ActivityProbe getProbe() {
    return probe;
  }


  public void setProbe(V1ActivityProbe probe) {
    this.probe = probe;
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      ...
      // validate the optional field `culling`
      if (jsonObj.get("culling") != null && !jsonObj.get("culling").isJsonNull()) {
        V1Culling.validateJsonObject(jsonObj.getAsJsonObject("culling"));
      }
      // validate the optional field `probe`
      if (jsonObj.get("probe") != null && !jsonObj.get("probe").isJsonNull()) {
        V1ActivityProbe.validateJsonObject(jsonObj.getAsJsonObject("probe"));
      }
  }
