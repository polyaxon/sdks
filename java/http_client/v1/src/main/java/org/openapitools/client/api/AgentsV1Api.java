...
import org.openapitools.client.model.V1AgentResourcesRequest;
...
public class AgentsV1Api {
    ...
    /**
     * Build call for checkAgentConnection
    ...
    private okhttp3.Call checkAgentConnectionValidateBeforeCall(String namespace, String owner, String uuid, V1AgentResourcesRequest body, final ApiCallback _callback) throws ApiException {
        ...
        if (owner == null) {
            throw new ApiException("Missing the required parameter 'owner' when calling checkAgentConnection(Async)");
        }
    ...
    /**
     * Check an agent connection (asynchronously)
     * 
     * @param namespace namespace (required)
     * @param owner Owner of the namespace (required)
     * @param uuid Uuid identifier of the entity (required)
     ...
     */
    public okhttp3.Call restartAgentCall(String namespace, String owner, String uuid, V1AgentResourcesRequest body, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/streams/v1/{namespace}/{owner}/agents/{uuid}/k8s_restart"
            .replace("{" + "namespace" + "}", localVarApiClient.escapeString(namespace.toString()))
            .replace("{" + "owner" + "}", localVarApiClient.escapeString(owner.toString()))
            .replace("{" + "uuid" + "}", localVarApiClient.escapeString(uuid.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call restartAgentValidateBeforeCall(String namespace, String owner, String uuid, V1AgentResourcesRequest body, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'namespace' is set
        if (namespace == null) {
            throw new ApiException("Missing the required parameter 'namespace' when calling restartAgent(Async)");
        }

        // verify the required parameter 'owner' is set
        if (owner == null) {
            throw new ApiException("Missing the required parameter 'owner' when calling restartAgent(Async)");
        }

        // verify the required parameter 'uuid' is set
        if (uuid == null) {
            throw new ApiException("Missing the required parameter 'uuid' when calling restartAgent(Async)");
        }

        // verify the required parameter 'body' is set
        if (body == null) {
            throw new ApiException("Missing the required parameter 'body' when calling restartAgent(Async)");
        }

        return restartAgentCall(namespace, owner, uuid, body, _callback);
     ...
     */
    public Object restartAgent(String namespace, String owner, String uuid, V1AgentResourcesRequest body) throws ApiException {
        ApiResponse<Object> localVarResp = restartAgentWithHttpInfo(namespace, owner, uuid, body);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Object> restartAgentWithHttpInfo(String namespace, String owner, String uuid, V1AgentResourcesRequest body) throws ApiException {
        okhttp3.Call localVarCall = restartAgentValidateBeforeCall(namespace, owner, uuid, body, null);
        Type localVarReturnType = new TypeToken<Object>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Restart agent service (asynchronously)
     * 
     * @param namespace namespace (required)
     * @param owner Owner of the namespace (required)
     * @param uuid Uuid identifier of the entity (required)
     ...
     */
    public okhttp3.Call restartAgentAsync(String namespace, String owner, String uuid, V1AgentResourcesRequest body, final ApiCallback<Object> _callback) throws ApiException {

        okhttp3.Call localVarCall = restartAgentValidateBeforeCall(namespace, owner, uuid, body, _callback);
        Type localVarReturnType = new TypeToken<Object>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
