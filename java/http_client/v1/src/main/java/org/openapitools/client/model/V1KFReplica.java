...
public class V1KFReplica {
  ...
  * @throws IOException if the JSON Object is invalid with respect to V1KFReplica
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!V1KFReplica.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in V1KFReplica is not found in the empty JSON string", V1KFReplica.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!V1KFReplica.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `V1KFReplica` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!V1KFReplica.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'V1KFReplica' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<V1KFReplica> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(V1KFReplica.class));

       return (TypeAdapter<T>) new TypeAdapter<V1KFReplica>() {
           @Override
           public void write(JsonWriter out, V1KFReplica value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public V1KFReplica read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of V1KFReplica given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of V1KFReplica
  * @throws IOException if the JSON string is invalid with respect to V1KFReplica
  */
  public static V1KFReplica fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, V1KFReplica.class);
  }

 /**
  * Convert an instance of V1KFReplica to an JSON string
  *
  * @return JSON string
  */
