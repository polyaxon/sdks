...
public class V1RunSettings {
  ...
  private List<V1RunReferenceCatalog> models = null;

  public static final String SERIALIZED_NAME_ARTIFACTS = "artifacts";
  @SerializedName(SERIALIZED_NAME_ARTIFACTS)
  private List<V1RunReferenceCatalog> artifacts = null;
  ...
  **/
  ...
  public V1RunSettings addModelsItem(V1RunReferenceCatalog modelsItem) {
    if (this.models == null) {
      this.models = new ArrayList<V1RunReferenceCatalog>();
    }
  ...
  **/
  ...
  public V1RunSettings addArtifactsItem(V1RunReferenceCatalog artifactsItem) {
    if (this.artifacts == null) {
      this.artifacts = new ArrayList<V1RunReferenceCatalog>();
    }
