...
public class V1ProjectSettings {
  ...
  public static final String SERIALIZED_NAME_RESTRICTIONS_TEMPLATE = "restrictions_template";
  @SerializedName(SERIALIZED_NAME_RESTRICTIONS_TEMPLATE)
  private String restrictionsTemplate;
  ...
  **/
  ...
  public V1ProjectSettings restrictionsTemplate(String restrictionsTemplate) {
    
    this.restrictionsTemplate = restrictionsTemplate;
    return this;
  }

   /**
   * Get restrictionsTemplate
   * @return restrictionsTemplate
  **/
  @javax.annotation.Nullable

  public String getRestrictionsTemplate() {
    return restrictionsTemplate;
  }


  public void setRestrictionsTemplate(String restrictionsTemplate) {
    this.restrictionsTemplate = restrictionsTemplate;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.connections, v1ProjectSettings.connections) &&
        ...
        Objects.equals(this.restrictionsTemplate, v1ProjectSettings.restrictionsTemplate);
  }

  @Override
  public int hashCode() {
    return Objects.hash(connections, preset, presets, queue, queues, agents, namespaces, userAccesses, teams, projects, restrictionsTemplate);
  }
  ...
  public String toString() {
    ...
    sb.append("    restrictionsTemplate: ").append(toIndentedString(restrictionsTemplate)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("restrictions_template");
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      ...
      if ((jsonObj.get("restrictions_template") != null && !jsonObj.get("restrictions_template").isJsonNull()) && !jsonObj.get("restrictions_template").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `restrictions_template` to be a primitive type in the JSON string but got `%s`", jsonObj.get("restrictions_template").toString()));
      }
  }
