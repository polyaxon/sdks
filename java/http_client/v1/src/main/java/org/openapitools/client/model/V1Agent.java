...
public class V1Agent {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(uuid, name, description, tags, liveState, user, namespace, versionApi, version, content, createdAt, updatedAt, status, statusConditions, isUiManaged, hostname, settings, stats, contributors);
  }
