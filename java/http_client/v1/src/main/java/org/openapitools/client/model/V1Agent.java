...
public class V1Agent {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(uuid, name, description, tags, liveState, namespace, versionApi, version, content, createdAt, updatedAt, status, statusConditions, isReplica, isUiManaged, settings);
  }
